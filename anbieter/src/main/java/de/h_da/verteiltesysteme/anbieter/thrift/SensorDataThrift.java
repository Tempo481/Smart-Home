...
public class SensorDataThrift implements org.apache.thrift.TBase<SensorDataThrift, SensorDataThrift._Fields>, java.io.Serializable, Cloneable, Comparable<SensorDataThrift> {
  ...
  public @org.apache.thrift.annotation.Nullable String nameOfSensor; // required
  public @org.apache.thrift.annotation.Nullable String typeOfSensor; // required
  ...
  public SensorDataThrift setNameOfSensor(@org.apache.thrift.annotation.Nullable String nameOfSensor) {
    this.nameOfSensor = nameOfSensor;
    return this;
  }
  ...
  public SensorDataThrift setTypeOfSensor(@org.apache.thrift.annotation.Nullable String typeOfSensor) {
    this.typeOfSensor = typeOfSensor;
    return this;
  }
  ...
  public int compareTo(SensorDataThrift other) {
    ...
    lastComparison = Boolean.valueOf(isSetNameOfSensor()).compareTo(other.isSetNameOfSensor());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetTypeOfSensor()).compareTo(other.isSetTypeOfSensor());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTypeOfSensor()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SensorDataThrift(");
    boolean first = true;
